...
pipeline = joblib.load("sentiments.pkl")
    ...
    if text_input.strip():
        with st.spinner("Translating and analyzing sentiment..."):
            ...
            if prediction.lower() == "positive":
                ...
                message = "🎉 Thank you for the valuable feedback on this product!"
                st.balloons()
                ...
                message = "😢 Ohh sorry! We'll work on improving this product."
                ...
                emoji = "😐"
                auto_rating = 3
                message = "🤝 Ohh, we'll try to improve this product for you!"
                st.warning("Your feedback helps us get better!")

        st.markdown(f"### 🛍️ Product: **{product_name if product_name else 'N/A'}**")
        st.markdown(f"### 🤖 Auto Rating : {'⭐' * auto_rating}")
